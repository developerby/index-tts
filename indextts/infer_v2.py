...
class IndexTTS2:
    ...
    def infer(self, spk_audio_prompt, text, output_path,
              ...
              verbose=False, max_text_tokens_per_segment=120, stream_return=False, more_segment_before=0, diffusion_steps=25, **generation_kwargs):
        if stream_return:
            return self.infer_generator(
                ...
                verbose, max_text_tokens_per_segment, stream_return, more_segment_before, diffusion_steps, **generation_kwargs
            )
        else:
    ...
    def infer_generator(self, spk_audio_prompt, text, output_path,
              ...
              emo_vector=None,
              use_emo_text=False, emo_text=None, use_random=False, interval_silence=200,
              verbose=False, max_text_tokens_per_segment=120, stream_return=False, quick_streaming_tokens=0, diffusion_steps=25, **generation_kwargs):
