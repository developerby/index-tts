...
class TTSStreamer:
    ...
    async def generate_and_stream(
        ...
        try:
            print(f"TTS generation: '{text}', emo_vector: {emo_vector}, emo_alpha: {emo_alpha}")
            ...
            await asyncio.get_event_loop().run_in_executor(
                ...
                lambda: self.tts.infer(
                    ...
                    emo_vector=emo_vector or TTSConfig.DEFAULT_EMO_VECTOR,
                    emo_alpha=emo_alpha or TTSConfig.DEFAULT_EMO_ALPHA,
                    verbose=True
                )
            )
            ...
            await self._stream_audio_file(output_path, websocket)
    ...
    async def _stream_audio_file(self, file_path: str, websocket: WebSocket):
        try:
...
async def websocket_tts_endpoint(websocket: WebSocket):
    ...
    try:
        while True:
            ...
            await tts_streamer.generate_and_stream(text, websocket, emo_vector, emo_alpha)
...
async def get_test_page():
    ...
    <body>
        <h1>TTS Streaming Test</h1>
        <input type="text" id="textInput" placeholder="Enter text" style="width: 400px;"><br><br>
        <input type="text" id="emoVector" placeholder="Emotion vector (e.g., 0,0,0,0,0,0,0.45,0)" style="width: 400px;"><br><br>
        <input type="number" id="emoAlpha" placeholder="Emotion alpha (e.g., 1.0)" step="0.1" style="width: 400px;"><br><br>
        ...
        <script>
            ...
            function sendText() {
                ...
                if (emoAlphaStr) {
                    payload.emo_alpha = parseFloat(emoAlphaStr);
                }
